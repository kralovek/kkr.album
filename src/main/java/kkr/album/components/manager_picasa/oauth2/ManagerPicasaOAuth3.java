...
public class ManagerPicasaOAuth3 extends ManagerPicasaOAuth2Fwk implements
		ManagerPicasa {
	...
	private static class Config {
		...
		static String GOOGLE_SCOPE_PICASA;
		static String GOOGLE_OAUTH_REFRESH_TOKEN;
		static String GOOGLE_REDIRECT_URI;
		static String GOOGLE_OAUTH_REFRESH_TOKEN_FILE;
		static String GOOGLE_TOKEN_SERVER_URL;
        ...
        try            {
            ...
            if (Config.GOOGLE_OAUTH_REFRESH_TOKEN.length() == 0)
                ...
                AuthorizationCodeFlow.Builder codeFlowBuilder = 
                                new GoogleAuthorizationCodeFlow(httpTransport, jsonFactory, CLIENT_ID, CLIENT_SECRET, scopes).Builder;
